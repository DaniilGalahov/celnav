...
class test_almanac(unittest.TestCase):
    ...
    def test_VectorAt(self):
        ...
        Vega=almanac.GetCelestialObject("Vega")
        vector_r=Vega.VectorAt(Y,M,D,h,m,s)
        self.assertAlmostEqual(vector_r[0],1403644055332.6636,2)
        self.assertAlmostEqual(vector_r[1],-8632442416192.56,2)
        self.assertAlmostEqual(vector_r[2],7028195907247.614,2)
